        ...
        <div class="min-h-full">
            <nav class="bg-gray-800">
                ...
                <div class="pt-4 pb-3 border-t border-gray-700">
                    ...
                    <a href="logout.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">Signout</a>
                    </div>
                </div>
                </div>
            </nav>
            ...
            <main>
                ...
                <div class="px-4 py-6 sm:px-0">
                    <div class="border-4 border-dashed border-gray-200 rounded-lg h-96">
                        <?php
                            $namecookie = $_COOKIE['user_session'];
                            echo "Bem vindo $namecookie";
                        ?>
                    </div>
                </div>
                <!-- /End replace -->
